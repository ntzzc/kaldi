...
inline void cuda_apply_exp(dim3 Gr, dim3 Bl, float* mat, MatrixDim d, cudaStream_t s=NULL) { cudaF_apply_exp(Gr,Bl,mat,d,s); }
...
inline void cuda_apply_ceiling(dim3 Gr, dim3 Bl, float* mat, float ceiling_val, MatrixDim dim, cudaStream_t s=NULL) { cudaF_apply_ceiling(Gr,Bl,mat,ceiling_val,dim,s); }
...
inline void cuda_add(dim3 Gr, dim3 Bl, float *mat, float value, MatrixDim d, cudaStream_t s=NULL) { cudaF_add(Gr,Bl,mat,value,d,s); }
...
inline void cuda_scale(dim3 Gr, dim3 Bl, float *mat, float value, MatrixDim d, cudaStream_t s=NULL) { cudaF_scale(Gr,Bl,mat,value,d,s); }
...
inline void cuda_mul_rows_vec(dim3 Gr, dim3 Bl, float *mat, const float *scale, MatrixDim d, cudaStream_t s=NULL) { cudaF_mul_rows_vec(Gr,Bl,mat,scale,d,s); }
...
inline void cuda_add_mat_blocks(dim3 Gr, dim3 Bl, float alpha, const float *src, int32_cuda num_row_blocks, int32_cuda num_col_blocks, float *dst, MatrixDim d, int src_stride, int A_trans, cudaStream_t s=NULL) { cudaF_add_mat_blocks(Gr, Bl, alpha, src, num_row_blocks, num_col_blocks, dst, d, src_stride, A_trans); }
...
inline void cuda_vec_mul_elements(int Gr, int Bl, float* v, const float* a, int dim, cudaStream_t s=NULL) { cudaF_vec_mul_elements(Gr,Bl,v,a,dim,s); }
...
inline void cuda_apply_exp(dim3 Gr, dim3 Bl, double* mat, MatrixDim d, cudaStream_t s=NULL) { cudaD_apply_exp(Gr,Bl,mat,d,s); }
...
inline void cuda_apply_ceiling(dim3 Gr, dim3 Bl, double* mat, double ceiling_val, MatrixDim dim, cudaStream_t s=NULL) { cudaD_apply_ceiling(Gr,Bl,mat,ceiling_val,dim,s); }
...
inline void cuda_add(dim3 Gr, dim3 Bl, double *mat, double value, MatrixDim d, cudaStream_t s=NULL) { cudaD_add(Gr,Bl,mat,value,d,s); }
...
inline void cuda_scale(dim3 Gr, dim3 Bl, double *mat, double value, MatrixDim d, cudaStream_t s=NULL) { cudaD_scale(Gr,Bl,mat,value,d,s); }
...
inline void cuda_mul_rows_vec(dim3 Gr, dim3 Bl, double *mat, const double *scale, MatrixDim d, cudaStream_t s=NULL) { cudaD_mul_rows_vec(Gr,Bl,mat,scale,d,s); }
...
inline void cuda_vec_mul_elements(int Gr, int Bl, double* v, const double* a, int dim, cudaStream_t s=NULL) { cudaD_vec_mul_elements(Gr,Bl,v,a,dim,s); }
