 ...
 * cu::
 */
void cudaF_softmax_reduce(size_t Gr, size_t Bl, float *y, const float *x, MatrixDim d, int src_stride, Real *logsum=NULL, cudaStream_t s=NULL);
 ...
 * cu::
 */
void cudaD_softmax_reduce(size_t Gr, size_t Bl, double *y, const double *x, MatrixDim d, int src_stride, Real *logsum=NULL, cudaStream_t s=NULL);
