...
void cudaF_apply_ceiling(dim3 Gr, dim3 Bl, float* mat, float ceiling_val, MatrixDim d, cudaStream_t s=NULL);
 ...
 * cu::
 */
void cudaF_softmax_reduce(size_t Gr, size_t Bl, float *y, const float *x, MatrixDim d, int src_stride, float *logsum=NULL, cudaStream_t s=NULL);
...
void cudaD_apply_ceiling(dim3 Gr, dim3 Bl, double* mat, double ceiling_val, MatrixDim d, cudaStream_t s=NULL);
 ...
 * cu::
 */
void cudaD_softmax_reduce(size_t Gr, size_t Bl, double *y, const double *x, MatrixDim d, int src_stride, double *logsum=NULL, cudaStream_t s=NULL);
