...
int main(int argc, char *argv[])
{
	try {
	    ...
	    decoding_opts.feature_opts(decoding_opts.feature_cfg);
		ReadConfigFromFile(decoding_opts.decoder_cfg, &decoding_opts.decoder_opts);
		ReadConfigFromFile(decoding_opts.forward_cfg, &decoding_opts.forward_opts);

		OnlineNnetForwardOptions &forward_opts = decoding_opts.forward_opts;
	    OnlineNnetFasterDecoderOptions &decoder_opts = decoding_opts.decoder_opts;
        ...
        OnlineNnetFeaturePipeline feature_pipeline(decoding_opts.feature_opts);
